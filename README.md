...
**Modern E Commerce Platform** — Professional project by Gabriel Demetrios Lafis

Total source lines: **60** across **3** files in **2** languages.
...
Total de linhas de código: **60** em **3** arquivos em **2** linguagens.
